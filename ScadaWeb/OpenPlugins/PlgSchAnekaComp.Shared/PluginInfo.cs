...
namespace Scada.Web.Plugins.PlgSchAnekaComp
{
    ...
    internal class PluginInfo : LibraryInfo
    {
        ...
        /// </summary>
        public override string Code => "PlgSchAnekaComp";
        ...
        public override string Name => Locale.IsRussian ?
            "СВГ компоненты схем" :
            "SVG Scheme Components";

        /// <summary>
        /// Gets the plugin description.
        /// </summary>
        public override string Descr => Locale.IsRussian ?
            "Набор СВГ компонентов для отображения на мнемосхемах." :
            "A set of SVG components for display on schemes.";
    }
}
