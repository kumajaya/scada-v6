...
namespace Scada.Comm.Drivers.DrvSigModbus.Logic
{
    ...
    /// </summary>
    internal class DrvSigModbusLogic : DrvModbusLogic
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvSigModbusLogic(ICommContext commContext)
            : base(commContext)
        {
        }
        ...
        {
            return new DevSigModbusLogic(CommContext, lineContext, deviceConfig);
        }
    }
}
