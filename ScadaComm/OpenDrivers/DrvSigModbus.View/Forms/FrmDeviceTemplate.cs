...
namespace Scada.Comm.Drivers.DrvSigModbus.View.Forms
{
    ...
    public partial class FrmDeviceTemplate : Form
    {
        ...
        {
            Text = (Modified ? "*" : "") + string.Format(DrvModbus.View.DriverPhrases.TemplateTitle, ShortFileName);
        }
        ...
        private static string GetElemGroupNodeText(ElemGroupConfig elemGroup)
        {
            return string.Format("{0} ({1})",
                string.IsNullOrEmpty(elemGroup.Name) ? DrvModbus.View.DriverPhrases.UnnamedElemGroup : elemGroup.Name,
        ...
        {
            string cmdName = string.IsNullOrEmpty(cmd.Name) ? DrvModbus.View.DriverPhrases.UnnamedCommand : cmd.Name;
        ...
        private bool ConfirmCloseTemplate()
        {
            if (Modified)
            {
                return MessageBox.Show(DrvModbus.View.DriverPhrases.SaveTemplateConfirm, CommonPhrases.QuestionCaption,
        ...
        private bool ValidateTemplate(out string message)
        {
            ...
            if (duplicatedCodes.Count > 0)
            {
                ...
                list.Sort();
                sbMessage
                    .AppendLine(DrvModbus.View.DriverPhrases.DuplicatedCodes)
            ...
            if (duplicatedCmdNums.Count > 0)
            {
                ...
                list.Sort();
                sbMessage
                    .AppendLine(DrvModbus.View.DriverPhrases.DuplicatedCmdNums)
                    .Append(string.Join(", ", list))
                    .AppendLine(".");
            }

            if (emptyTagCodeExists)
                sbMessage.AppendLine(DrvModbus.View.DriverPhrases.EmptyTagCodes);

            if (emptyCmdCodeExists)
                sbMessage.AppendLine(DrvModbus.View.DriverPhrases.EmptyCmdCodes);
            ...
            {
                message = DrvModbus.View.DriverPhrases.VerificationPassed;
                return true;
            }
        }
        ...
        private void FrmDevTemplate_Load(object sender, EventArgs e)
        {
            ...
            elemGroupsNode.Text = DrvModbus.View.DriverPhrases.ElemGroupsNode;
            commandsNode.Text = DrvModbus.View.DriverPhrases.CommandsNode;
        ...
        private void btnAddElem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(string.Format(DrvModbus.View.DriverPhrases.ElemCntExceeded, elemGroup.MaxElemCnt),
        ...
        private void miCloneElemConfig_Click(object sender, EventArgs e)
        {
            ...
            if (selectedElemTag != null &&
                MessageBox.Show(DrvModbus.View.DriverPhrases.CloneElemConfigConfirm, CommonPhrases.QuestionCaption,
                    MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                foreach (ElemConfig elemConfig in selectedElemTag.ElemGroup.Elems)
                {
                    if (elemConfig != selectedElem)
                    {
                        ...
                        ((SigElemConfig)elemConfig).Scaling = ((SigElemConfig)selectedElem).Scaling;
                    }
                }
