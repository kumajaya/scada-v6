...
using Scada.Comm.Drivers.DrvSigModbus.View.Forms;
using Scada.Forms;
using Scada.Lang;
...
namespace Scada.Comm.Drivers.DrvSigModbus.View
{
    ...
    /// </summary>
    public class DrvSigModbusView : DrvModbusView
    {
        /// <summary>
        /// Initializes a new instance of the class.
        /// </summary>
        public DrvSigModbusView()
             : base()
        {
        }
        ...
        public override void LoadDictionaries()
        {
            ...
            if (!Locale.LoadDictionaries(AppDirs.LangDir, "DrvSigModbus", out string errMsg))
        ...
        {
            return new DevSigModbusView(this, lineConfig, deviceConfig, GetCustomUi());
        }
    }
}
