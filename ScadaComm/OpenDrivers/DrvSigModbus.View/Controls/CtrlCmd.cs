...
namespace Scada.Comm.Drivers.DrvSigModbus.View.Controls
{
    ...
    public partial class CtrlCmd : UserControl
    {
        ...
        private void ShowCmdConfig(CmdConfig cmd)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    lblCmdAddressHint.Text = string.Format(DrvModbus.View.DriverPhrases.AddressHint, AddrNotation, AddrShift);
        ...
        {
            if (cmd != null && ((SigCmdConfig)cmd).ScalingEnabled &&
                    (cmd.ElemType == ElemType.UShort || cmd.ElemType == ElemType.Short))
            {
                txtCmdScaling.Text = ((SigCmdConfig)cmd).Scaling;
        ...
        private void txtCmdScaling_TextChanged(object sender, EventArgs e)
        {
            ...
            if (cmd != null)
            {
                ((SigCmdConfig)cmd).Scaling = txtCmdScaling.Text;
                OnObjectChanged(TreeUpdateTypes.None);
            }
        }
    }
