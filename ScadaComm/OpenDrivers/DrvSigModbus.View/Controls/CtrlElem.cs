    ...
    public partial class CtrlElem : UserControl
    {
        ...
        private void ShowElemConfig(ElemTag elemTag)
        {
            ...
            else
            {
                ...
                txtElemScaling.Text = ((SigElemConfig)elem).Scaling;
                txtElemScaling.Enabled = ((SigElemGroupConfig)elemGroup).ScalingEnabled &&
        ...
        private void rbType_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (elemTag != null && ((RadioButton)sender).Checked)
            {
                ...
                txtElemAddress.Text = elemTag.AddressRange;
                txtElemScaling.Text = ((SigElemConfig)elemTag.Elem).Scaling;
                txtElemScaling.Enabled = ((SigElemGroupConfig)elemTag.ElemGroup).ScalingEnabled &&
        ...
        private void txtScaling_TextChanged(object sender, EventArgs e)
        {
            ...
            if (elemTag != null)
            {
                ((SigElemConfig)elemTag.Elem).Scaling = txtElemScaling.Text;
                OnObjectChanged(TreeUpdateTypes.None);
            }
        }
    }
